    ...
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="card space-y-6">
        ...
        <div>
          ...
          <input id="member_id" name="member_id" type="text" className="input" defaultValue={String(record.member_id ?? "")} />
        </div>
        <div>
        ...
        <div>
          ...
          <input id="invited_at" name="invited_at" type="datetime-local" className="input" defaultValue={String(record.invited_at ?? "")} />
        </div>
        <div>
          <label htmlFor="accepted_at" className="label">Accepted At</label>
          <input id="accepted_at" name="accepted_at" type="datetime-local" className="input" defaultValue={String(record.accepted_at ?? "")} />
        </div>
